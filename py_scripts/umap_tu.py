...
def main():
    ...
    for key in embed_keys:
        ...
        sc.pp.neighbors(adata_tu, use_rep=key, key_added=neighbors_key)
        sc.tl.umap(adata_tu, neighbors_key=neighbors_key, key_added=umap_key)
